...
declare class Node {
    ...
    render(data?: Record<string, MMEditorNode>): Promise<unknown>;
    /**
     * 添加节点
     * @param {object} data
     */
    addNode: (data: MMEditorNode) => InstanceNode;
    /**
     * 删除节点
     *  @param {object} data
     */
    deleteNode: (input: MMEditorNode | string, noEvent?: boolean) => void;
    /**
     * 渲染新节点
     */
     ...
     * 根据数据更新节点位置
     */
    updateNode(input: MMEditorNode | string, rerenderShape?: boolean): void;
    /**
     * 给节点添加连线点
     * @param {node} node
     */
